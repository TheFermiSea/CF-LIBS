...
- Use `cflibs generate-manifold` for supported manifold builds.
- Do not launch the legacy `manifold-generator.py` script with `mpirun` or `srun`;
  it is not MPI-aware and will duplicate work unless explicit MPI support is added.
